...
- (void)viewWillAppear:(BOOL)animated {
    ...
    [self.customNavigationBar setBackgroundImage:[[UIImage alloc] init] forBarPosition:UIBarPositionAny barMetrics:UIBarMetricsDefault];
    [self.customNavigationBar setTintColor:[UIColor whiteColor]];
    [self.customNavigationBar setBarTintColor:nil];
    [self.customNavigationBar setClipsToBounds:YES];
